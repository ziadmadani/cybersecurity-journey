...
but using find command with the name inhere which guide me to the hidden file which had the password in it and open it using the cat command with the path directory/hidden file
